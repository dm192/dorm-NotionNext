const CONFIG = {
  ...
  // Aurora 外观配置（通过本文件修改）
  AURORA_ACCENT_PRIMARY: '#0ea5a4',
  AURORA_ACCENT_SECONDARY: '#38bdf8',
  ...
  HEO_SITE_CREATE_TIME: '2026-01-19', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '可以看看我的 Github 主页吗？', url: 'https://github.com/dm192' },
    { title: '❤️我喜欢你❤️', url: 'https://www.bilibili.com/video/BV1hq4y1s7VH/' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '分享',
  HEO_HERO_TITLE_2: '与创新',
  HEO_HERO_TITLE_3: '当然我会的不多🤣',
  HEO_HERO_TITLE_4: '你知道吗？',
  HEO_HERO_TITLE_5: '我不知道...',
  HEO_HERO_TITLE_LINK: 'https://www.bilibili.com/video/BV1hq4y1s7VH/',
  // 英雄区遮罩文字
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/dm192',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://space.bilibili.com/2050548410',
