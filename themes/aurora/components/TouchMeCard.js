...
export default function TouchMeCard() {
  if (!JSON.parse(siteConfig('AURORA_SOCIAL_CARD', null, CONFIG))) return <></>
  ...
  return (
    <div className='relative h-28 text-white flex flex-col'>
      <FlipCard
        ...
        frontContent={
          <div className='h-full relative'>
            <h2 className='font-black text-2xl'>
              {siteConfig('AURORA_SOCIAL_CARD_TITLE_1', null, CONFIG)}
            </h2>
            <h3 className='pt-1 text-sm opacity-90'>
              {siteConfig('AURORA_SOCIAL_CARD_TITLE_2', null, CONFIG)}
            </h3>
            <div
        ...
        backContent={
          <SmartLink href={siteConfig('AURORA_SOCIAL_CARD_URL', null, CONFIG)}>
            <div className='font-black text-lg h-full flex items-center justify-center'>
              {siteConfig('AURORA_SOCIAL_CARD_TITLE_3', null, CONFIG)}
            </div>
          </SmartLink>
        }
      />
